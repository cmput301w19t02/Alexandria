...
public class MessageTests {
    ...
    private class TestMessage extends Message{
        ...
        public TestMessage(String type, String content, String status, String date, String sender) {
    ...
    public void constructorTest() {
        Date date = new Date();
        Message message = new TestMessage("text","TEST content","unread", date.toString(), "johndoe@email.com");
    ...
    public void emptyTypeConstructorTest() {
        new TestMessage("", "TEST content", "unread", new Date().toString(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptyContentConstructorTest() {
        new TestMessage("text", "", "unread", new Date().toString(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptyStatusConstructorTest() {
        new TestMessage("text", "TEST content", "", new Date().toString(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptySenderConstructorTest() {
        new TestMessage("text", "TEST content", "unread", new Date().toString(),"");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullTypeConstructorTest() {
        new TestMessage(null, "TEST content", "unread", new Date().toString(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullContentConstructorTest() {
        new TestMessage("text", null, "unread", new Date().toString(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullStatusConstructorTest(){
        new TestMessage("text", "TEST content", null, new Date().toString(),"johndoe@email.com");
    }
    ...
    public void nullSenderConstructorTest(){
        new TestMessage("text", "TEST content", "unread", new Date().toString(), null);
    }
    // positive setType
    @Test
    public void setTypeTest(){
        Message message = new TestMessage("text", "TEST content", "unread", new Date().toString(), "johndoe@email.com");
