...
public class MessageTests {
    ...
    private class TestMessage extends Message{
        ...
        public TestMessage(String type, String content, String status, long date, String sender) {
    ...
    public void constructorTest() {
        ...
        Message message = new TestMessage("text","TEST content","unread", dateTime, "johndoe@email.com");
        assertEquals("text", message.getType());
        assertEquals("TEST content", message.getContent());
        assertEquals("unread", message.getStatus());
        assertEquals(Long.valueOf(dateTime), message.getDate());
        assertEquals("johndoe@email.com", message.getSender());
    }
    // negative constructor tests
    @Test(expected = IllegalArgumentException.class)
    public void emptyTypeConstructorTest() {
        new TestMessage("", "TEST content", "unread", new Date().getTime(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptyContentConstructorTest() {
        new TestMessage("text", "", "unread", new Date().getTime(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptyStatusConstructorTest() {
        new TestMessage("text", "TEST content", "", new Date().getTime(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptySenderConstructorTest() {
        new TestMessage("text", "TEST content", "unread", new Date().getTime(),"");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullTypeConstructorTest() {
        new TestMessage(null, "TEST content", "unread", new Date().getTime(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullContentConstructorTest() {
        new TestMessage("text", null, "unread", new Date().getTime(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullStatusConstructorTest(){
        new TestMessage("text", "TEST content", null, new Date().getTime(),"johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullSenderConstructorTest(){
        new TestMessage("text", "TEST content", "unread", new Date().getTime(), null);
    }
    // positive setType
    @Test
    public void setTypeTest(){
        Message message = new TestMessage("text", "TEST content", "unread", new Date().getTime(), "johndoe@email.com");
