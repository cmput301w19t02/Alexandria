...
public class TextMessageTests {
    ...
    public void constructorTest() {
        Date date = new Date();
        TextMessage message = new TextMessage("TEST content", "unread", date.getTime(), "johndoe@email.com");
    ...
    public void emptyTextConstructorTest() {
        new TextMessage("", "unread", new Date().getTime(), "johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptyStatusConstructorTest() {
        new TextMessage("TEST content", "", new Date().getTime(), "johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void emptySenderConstructorTest() {
        new TextMessage("TEST content", "unread", new Date().getTime(), "");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullTextConstructorTest() {
        new TextMessage(null, "unread", new Date().getTime(), "johndoe@email.com");
    }

    @Test(expected = IllegalArgumentException.class)
    public void nullStatusConstructorTest() {
        new TextMessage("TEST content", null, new Date().getTime(), "johndoe@email.com");
    }
    ...
    public void nullSenderConstructorTest() {
        new TextMessage("TEST content", "unread", new Date().getTime(), null);
    }

    // positive setText
    @Test
    public void setTextTest() {
        TextMessage message = new TextMessage("TEST content", "unread", new Date().getTime(), "johndoe@email.com");
