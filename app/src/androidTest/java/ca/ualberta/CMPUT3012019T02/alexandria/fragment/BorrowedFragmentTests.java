...
public class BorrowedFragmentTests {
    @Rule
    ...
    public void testProfileAttributes() throws InterruptedException, TimeoutException, ExecutionException {
        ...
        Book book = BookController.getInstance().getBook("074754624X").get(5, TimeUnit.SECONDS).get();

        BorrowedFragment frag = new BorrowedFragment();
