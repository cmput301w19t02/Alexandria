...
public class RequestedFragmentTests {
    @Rule
    ...
    public void testProfileAttributes() throws InterruptedException, TimeoutException, ExecutionException {
        ...
        Book book = BookController.getInstance().getBook("9780547928227").get(5, TimeUnit.SECONDS).get();

        RequestedFragment frag = new RequestedFragment();
